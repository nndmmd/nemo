<?php
/* Smarty version 3.1.29, created on 2016-03-24 01:20:29
  from "/var/www/html/tl/app/views/app-home.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56f340dd2082e6_47255134',
  'file_dependency' => 
  array (
    '05d5249091cc1c1141310181e5fb7947df2577a7' => 
    array (
      0 => '/var/www/html/tl/app/views/app-home.html',
      1 => 1458697714,
      2 => 'file',
    ),
  ),
...
function content_56f340dd2082e6_47255134 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
<header class="navbar-wrapper">
	<div class="navbar navbar-black navbar-fixed-top">
		<div class="container cl">
			<a class="logo navbar-logo f-l mr-10 hidden-xs" href="/tl/public/appstore">App Store 应用商店</a>
			...
			<nav class="nav navbar-nav nav-collapse" role="navigation" id="Hui-navbar">
				<ul class="cl">
					<li class="current"><a href="/tl/public/appstore">返回首页</a></li>
...
<div class="panel panel-danger radius mt-10">
	...
	<table class="table col-md-4">
		...
		<span class="badge badge-danger radius">64</span>
		</td> <td width="33.33%">
		...
		<span class="badge badge-danger radius">11</span>
		</td> <td width="33.33%">
	...
	<table class="table col-md-4">
		...
		<img src="assets/images/app1.png" alt="app1" class="img-responsive radius"> 
		<span class="label label-default radius">数据留声机</span>
		<span class="badge badge-danger radius">47</span>
		</td> <td width="33.33%">
		<img src="assets/images/app2.png" alt="app2" class="img-responsive radius"> 
		<span class="label label-default radius">平台监控</span>
		<span class="badge badge-danger radius">18</span>
		</td> <td width="33.33%">
		<img src="assets/images/app3.png" alt="app3" class="img-responsive radius"> 
		<span class="label label-default radius">豆果美食</span>
		<span class="badge badge-danger radius">98</span>
		</td> </tr>
		<tr> <td width="33.33%">
		<img src="assets/images/app4.png" alt="app1" class="img-responsive radius"> 
		<span class="label label-default radius">排班神器</span>
		...
		<img src="assets/images/app5.png" alt="app2" class="img-responsive radius"> 
		<span class="label label-default radius">云主机</span>
		<span class="badge badge-danger radius">99</span>
		</td> <td width="33.33%">
		<img src="assets/images/app6.png" alt="app3" class="img-responsive radius"> 
		<span class="label label-default radius">社区金融</span>
		<span class="badge badge-danger radius">21</span>
		</td> </tr>
		</tbody>
	</table>
	<table class="table col-md-4">
		...
		<img src="assets/images/app6.png" alt="app3" class="img-responsive radius"> 
		<span class="label label-default radius">社区金融</span>
		<span class="badge badge-danger radius">54</span>
		</td> </tr>
		</tbody>
	</table>
	</div>
