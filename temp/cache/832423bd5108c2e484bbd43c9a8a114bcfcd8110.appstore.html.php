<?php
/* Smarty version 3.1.29, created on 2016-03-23 06:24:56
  from "/var/www/html/tinylara/app/views/appstore.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56f236b8b0a934_07644550',
  'file_dependency' => 
  array (
    '832423bd5108c2e484bbd43c9a8a114bcfcd8110' => 
    array (
      0 => '/var/www/html/tinylara/app/views/appstore.html',
      1 => 1458697714,
      2 => 'file',
    ),
  ),
...
function content_56f236b8b0a934_07644550 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
<div class="panel panel-danger radius mt-10">
	...
	<table class="table col-md-4">
		...
		<span class="badge badge-danger radius">67</span>
		</td> <td width="33.33%">
		...
		<span class="badge badge-danger radius">14</span>
		</td> </tr>
		</tbody>
	</table>
	<table class="table col-md-4">
		...
		<img src="assets/images/app2.png" alt="app2" class="img-responsive radius"> 
		<span class="label label-default radius">平台监控</span>
		<span class="badge badge-danger radius">84</span>
		</td> <td width="33.33%">
		<img src="assets/images/app3.png" alt="app3" class="img-responsive radius"> 
		<span class="label label-default radius">豆果美食</span>
	...
	<table class="table col-md-4">
		...
		<img src="assets/images/app1.png" alt="app1" class="img-responsive radius"> 
		<span class="label label-default radius">数据留声机</span>
		<span class="badge badge-danger radius">80</span>
		</td> <td width="33.33%">
		<img src="assets/images/app2.png" alt="app2" class="img-responsive radius"> 
		<span class="label label-default radius">平台监控</span>
		<span class="badge badge-danger radius">1</span>
		</td> <td width="33.33%">
		<img src="assets/images/app3.png" alt="app3" class="img-responsive radius"> 
		<span class="label label-default radius">豆果美食</span>
		<span class="badge badge-danger radius">7</span>
		</td> </tr>
		<tr> <td width="33.33%">
		<img src="assets/images/app4.png" alt="app1" class="img-responsive radius"> 
		<span class="label label-default radius">排班神器</span>
