<?php
/* Smarty version 3.1.29, created on 2016-03-25 09:33:53
  from "/var/www/html/tinylara/app/views/app-home.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_56f506013858a9_41812155',
  'file_dependency' => 
  array (
    'a9673234f5866a3a60ab721fba072e760f75de5c' => 
    array (
      0 => '/var/www/html/tinylara/app/views/app-home.html',
      1 => 1458697714,
      2 => 'file',
    ),
  ),
...
function content_56f506013858a9_41812155 ($_smarty_tpl) {
?>
<!DOCTYPE HTML>
<html>
<head>
...
<header class="navbar-wrapper">
	<div class="navbar navbar-black navbar-fixed-top">
		<div class="container cl">
			<a class="logo navbar-logo f-l mr-10 hidden-xs" href="/tinylara/public/appstore">App Store 应用商店</a>
			...
			<nav class="nav navbar-nav nav-collapse" role="navigation" id="Hui-navbar">
				<ul class="cl">
					<li class="current"><a href="/tinylara/public/appstore">返回首页</a></li>
...
<div class="panel panel-danger radius mt-10">
	...
	<table class="table col-md-4">
		...
		<img src="assets/images/app1.png" alt="app1" class="img-responsive radius"> 
		<span class="label label-default radius">数据留声机</span>
		<span class="badge badge-danger radius">2</span>
		</td> <td width="33.33%">
		<img src="assets/images/app2.png" alt="app2" class="img-responsive radius"> 
		<span class="label label-default radius">平台监控</span>
		...
		<img src="assets/images/app4.png" alt="app1" class="img-responsive radius"> 
		<span class="label label-default radius">排班神器</span>
		<span class="badge badge-danger radius">46</span>
		</td> <td width="33.33%">
		<img src="assets/images/app5.png" alt="app2" class="img-responsive radius"> 
		<span class="label label-default radius">云主机</span>
		...
		<img src="assets/images/app6.png" alt="app3" class="img-responsive radius"> 
		<span class="label label-default radius">社区金融</span>
		<span class="badge badge-danger radius">96</span>
		</td> </tr>
		</tbody>
	</table>
	<table class="table col-md-4">
		...
		<img src="assets/images/app2.png" alt="app2" class="img-responsive radius"> 
		<span class="label label-default radius">平台监控</span>
		<span class="badge badge-danger radius">58</span>
		</td> <td width="33.33%">
		<img src="assets/images/app3.png" alt="app3" class="img-responsive radius"> 
		<span class="label label-default radius">豆果美食</span>
